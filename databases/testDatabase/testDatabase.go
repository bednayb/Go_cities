...
var Cities = []cityStructs.CityInfo{
	...
	cityStructs.CityInfo{"becs", cityStructs.Geo{96, 96}, [5]float64{20, 3, 17, 5, 6}, [5]float64{0.5, 0.3, 0.4, 0.5, 0.6}, 1002},
	cityStructs.CityInfo{"paris", cityStructs.Geo{95, 95}, [5]float64{50, 3, 17, 5, 6}, [5]float64{0.5, 0.3, 0.4, 0.5, 0.6}, time.Now().Unix()},
}
